...
{{-- <div id="edit_modal" class="fixed bottom-0 right-0 w-96 bg-white p-4 border border-gray-300 rounded-lg shadow-lg hidden modal-enter">
    ...
    <textarea class="first w-full border border-gray-300 rounded-lg p-2 mb-4" rows="4" placeholder="Write your email..."></textarea>
    <textarea class="second w-full border border-gray-300 rounded-lg p-2 mb-4" rows="4" placeholder="Write your email..."></textarea>
